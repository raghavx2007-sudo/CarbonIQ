  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        // Handle array of zod errors or single string
    ...
    <main className="max-w-md mx-auto mt-16 bg-white p-8 rounded-lg shadow-sm border border-slate-200">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          />
          <p id="password-hint" className="mt-1 text-xs text-slate-500">Must be at least 8 characters with 1 uppercase and 1 number.</p>
        </div>
